...
void OLED_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(OLED_RCCEN | RCC_APB2Periph_GPIOA, ENABLE); 	 //GPIO初始化
    ...
    OLED_GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;
    OLED_GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    OLED_GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
...
void Oled_Show(void)
{
	OLED_P6x8Str(0, 1, (unsigned char*)"Kp:");
	  LCD_FloatShow(20, 1, Velcity_Kp);
    OLED_P6x8Str(60, 1, (unsigned char*)"Ki:");
      LCD_FloatShow(80, 1, Velcity_Ki);
	
	OLED_P6x8Str(0, 3, (unsigned char*)"Tg:");
	  LCD_FloatShow(20, 3, TargetVelocity);
    OLED_P6x8Str(60, 3, (unsigned char*)"Sp:");
      LCD_FloatShow(80, 3, Encoder);
	
	OLED_P6x8Str(0, 5, (unsigned char*)"PW:");
	  LCD_FloatShow(20, 5, PWM);
	OLED_P6x8Str(60, 5, (unsigned char*)"Bias:");
      LCD_FloatShow(80, 5, Bias);
}
